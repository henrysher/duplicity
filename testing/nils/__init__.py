...
class FunctionalTestCase(DuplicityTestCase):
    ...
    def setUp(self):
        ...
        self.class_args = []
        self.backend_url = "dpbx:///testfiles/output"
        self.last_backup = None
        self.set_environ('PASSPHRASE', self.sign_passphrase)
        self.set_environ("SIGN_PASSPHRASE", self.sign_passphrase)
        self.set_environ("DPBX_APP_KEY", "trsyeoi9h23x3rv")
        self.set_environ("DPBX_APP_SECRET", "ayxhen7ojvza1wo")
        self.set_environ("DPBX_ACCESS_TOKEN", "7HslJwV13ZAAAAAAAAAAC_jCBV4ZHyPFx-I4jsRplpJwQ2tMFesgEcndc78A8pyp")
